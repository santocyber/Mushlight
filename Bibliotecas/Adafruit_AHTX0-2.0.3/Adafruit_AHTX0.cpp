...
/**
 * @brief  Gets the sensor_t1 object describing the AHTx0's humidity sensor
 *
 * @param sensor The sensor_t1 object to be populated
 */
void Adafruit_AHTX0_Humidity::getSensor(sensor_t1 *sensor) {
  /* Clear the sensor_t1 object */
  memset(sensor, 0, sizeof(sensor_t1));
...
/**
 * @brief  Gets the sensor_t1 object describing the AHTx0's tenperature sensor
 *
 * @param sensor The sensor_t1 object to be populated
 */
void Adafruit_AHTX0_Temp::getSensor(sensor_t1 *sensor) {
  /* Clear the sensor_t1 object */
  memset(sensor, 0, sizeof(sensor_t1));
